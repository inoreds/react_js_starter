    ...
    render(){
        return(
            <div className="home-slider">
                ...
                <div className="df-logo-initial mg-b-15"><p>rjs</p></div>
                <p className="home-text">ReactJs Starter Frontend Template</p>

                <h6 className="home-headline">Frontend starter template built with reactjs. I Build that<span>With My Heart</span> and <span>My Time</span> While I'm still single. :v</h6>

                <div className="d-flex wd-lg-350">
                <a href="https://themeforest.net/item/dashforge-responsive-admin-dashboard-template/23725961" className="btn btn-brand-01 flex-fill btn-icon"><i className="fab fa-facebook"> Facebook</i></a>
                <a href="template/classic/dashboard-one.html" className="btn btn-white flex-fill mg-l-10"><i className="fab fa-instagram"> Instagram</i></a>
                </div>
